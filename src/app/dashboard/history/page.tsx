...
export default async function HistoryPage() {
  ...
  return (
    <div
      className="min-h-screen bg-[#0a0d27] text-white"
      style={{ fontFamily: "'Google Sans', Roboto, sans-serif" }}
    >
      <div className="max-w-[1400px] mx-auto px-6 py-14 flex flex-col gap-10 animate-in fade-in duration-700">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
          <div className="p-8 rounded-[2rem] bg-white/[0.03] border border-white/5 flex flex-col justify-between min-h-[160px] hover:bg-white/[0.05] transition-colors">
            <span className="text-[13px] font-medium text-gray-400 tracking-wide uppercase">Total Records</span>
            <div className="text-5xl font-light tracking-tight mt-4 text-white">{totalLogs}</div>
          </div>

          <div className="p-8 rounded-[2rem] bg-indigo-500/[0.03] border border-indigo-500/10 flex flex-col justify-between min-h-[160px] hover:bg-indigo-500/[0.05] transition-colors">
            <span className="text-[13px] font-medium text-indigo-200/60 tracking-wide uppercase">Active</span>
            <div className="text-5xl font-light tracking-tight mt-4 text-white">{activeLogs}</div>
          </div>

          <div className="p-8 rounded-[2rem] bg-emerald-500/[0.03] border border-emerald-500/10 flex flex-col justify-between min-h-[160px] hover:bg-emerald-500/[0.05] transition-colors">
            <span className="text-[13px] font-medium text-emerald-200/60 tracking-wide uppercase">Returned</span>
            <div className="text-5xl font-light tracking-tight mt-4 text-white">{returnedLogs}</div>
          </div>

          <div className="p-8 rounded-[2rem] bg-rose-500/[0.03] border border-rose-500/10 flex flex-col justify-between min-h-[160px] relative overflow-hidden group hover:bg-rose-500/[0.05] transition-colors">
            <span className="text-[13px] font-medium text-rose-400/70 tracking-wide uppercase z-10">Overdue</span>
            <div className="text-5xl font-light tracking-tight mt-4 text-rose-300 z-10">{overdueLogs}</div>
            <div className="absolute -bottom-10 -right-10 w-36 h-36 bg-rose-500/5 blur-[40px] rounded-full pointer-events-none group-hover:bg-rose-500/10 transition-colors" />
          </div>
        </div>
